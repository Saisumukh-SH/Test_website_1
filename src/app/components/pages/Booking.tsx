      ...
      <section className="py-28">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-neutral-400 text-lg">
            ...
            renovation project and provide a detailed quote.
          </p>
        </div>
      </section>
      ...
      <section className="pb-28">
        <div className="max-w-3xl mx-auto px-6">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-white text-black py-4 rounded-xl hover:scale-[1.02] transition"
            >
...
function Input({ icon: Icon, label, name, value, onChange, type = 'text' }: any) {
  return (
    <div>
      <label className="block mb-2 text-neutral-400">{label}</label>

      <div className="relative">

        <Icon className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-500" size={20} />
        ...
        <input
          ...
          value={value}
          onChange={onChange}
          className="w-full pl-10 pr-4 py-3 bg-neutral-950 border border-neutral-700 rounded-xl focus:outline-none focus:border-white"
        />
    ...
    <div>
      ...
      <div className="relative">
        ...
        <select
          ...
          value={value}
          onChange={onChange}
          className={`w-full ${Icon ? 'pl-10' : 'pl-4'} pr-4 py-3 bg-neutral-950 border border-neutral-700 rounded-xl focus:outline-none focus:border-white`}
        >
